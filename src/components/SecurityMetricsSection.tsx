    ...
    <section id="seguranca" className="py-20 bg-background border-t border-border">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-accent mb-4">Segurança da Informação e Cibersegurança</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {metrics.map((m) => {
            const Icon = m.icon;
            return (
              <div key={m.label} className="group bg-card border border-border rounded-xl p-6 shadow-sm hover:shadow-md transition">
