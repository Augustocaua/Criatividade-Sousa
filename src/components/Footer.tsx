...
+              <span className="text-2xl font-bold text-accent">Criatividade Sousa</span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={link.name} data-sr="up" data-sr-duration="0.6" data-sr-delay={index * 0.04}>
                  <a
                    href={link.href}
          ...
          <div>
            ...
            <div className="space-y-4">
              <div data-sr="up" data-sr-duration="0.6" data-sr-delay="0.00" className="flex items-start space-x-3">
              ...
              <div data-sr="up" data-sr-duration="0.6" data-sr-delay="0.06" className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-black flex-shrink-0" />
                <button
                  onClick={handleWhatsApp}
                  className="text-black hover:text-background transition-colors"
                >
                  (71) 987929082
                </button>
              </div>
              
              <div data-sr="up" data-sr-duration="0.6" data-sr-delay="0.12" className="flex items-center space-x-3">
        ...
        <div className="border-t border-background/20 pt-8 text-center">
          <p data-sr="fade" data-sr-duration="0.8" className="text-black">
            © 2025 Criatividade Sousa. Todos os direitos reservados. 
            Feito com ❤️ para criar <span className="whitespace-nowrap">momentos especiais</span>.
          </p>
        </div>
      </div>
    </footer>
