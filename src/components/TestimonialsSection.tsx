  ...
  return (
    <section id="depoimentos" className="py-16 sm:py-20 bg-gradient-to-br from-secondary to-muted">
      <div className="container mx-auto px-4">
        ...
        {/* WhatsApp CTA */}
        <div className="text-center bg-card p-6 sm:p-8 rounded-3xl shadow-lg border border-border animate-slide-up">
          ...
          <button
            ...
            className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold px-6 py-3 text-base sm:px-8 sm:py-4 sm:text-lg rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
